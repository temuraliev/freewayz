...
4. **subtype**: Тип товара на русском. Выбирай СТРОГО из списка:
   - **Верх**: Худи, Зипки, Свитшоты, Футболки, Лонгсливы, Рубашки, Поло.
   - **Низ**: Джинсы, Штаны, Брюки, Шорты, Джорты.
   - **Верхняя одежда**: Куртки, Пуховики, Ветровки, Бомберы, Жилеты.
   - **Обувь**: Кроссовки, Кеды, Ботинки, Тапочки.
   - **Аксессуары**: Кепки, Шапки, Сумки, Рюкзаки, Кабели, Ремни.
